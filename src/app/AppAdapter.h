...
class AppAdapter {
    private:
        ...
        void handleEndTask(const nlohmann::json& msg);
        ...
        void handleCreatePoi(const nlohmann::json& msg);
        void handleDeletePoi(const nlohmann::json& msg);
        void handleCreateZone(const nlohmann::json& msg);
        void handleDeleteZone(const nlohmann::json& msg);
